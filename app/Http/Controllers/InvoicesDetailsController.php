...
class InvoicesDetailsController extends Controller
{
    ...
    //$responce=response()->download(public_path().'/Attachments'.'/'.$invoice_number.'/'.$file_name, 'example.pdf', [], 'inline');
    //ob_end_clean();
    //return $responce;
    return asset(public_path().'/Attachments'.'/'.$invoice_number.'/'.$file_name);
}
}
