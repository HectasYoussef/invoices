                             ...
                             <div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">{{ auth()->user()->unreadNotifications->count() }}عدد الاشعارات الغير مقروءه</p>
									</div>
									...
									<div class="main-notification-list Notification-scroll">
										<a class="d-flex p-3 border-bottom" href="{{ url('InvoicesDetails') }}/{{ $notification->data["id"] }}">
                                            ...
                                            <div class="mr-3">
												...
												<h5 class="notification-label mb-1">{{ $notification->data["user"] }} ajoute nouvelle facture {{ $notification->data["title"] }}</h5>
									...
									<div class="dropdown-footer">
										<a href="{{ auth()->user()->unreadNotifications->markAsRead() }}">VIEW ALL</a>
									</div>
								</div>
							</div>
                             @endcan
